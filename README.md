...
📖PageOracle — это программа написанная на python c веб и настольным интерфейсом для чтения книг на основе искусственного интеллекта, которая позволяет пользователям загружать текстовые документы и задавать вопросы об их содержании. Она интеллектуально обрабатывает книги, использует передовые модели искусственного интеллекта для поиска нужной информации, а затем генерирует точные, контекстно-зависимые ответы или цитаты — и все это с помощью интуитивно понятного графического интерфейса.
...
[Глава I. Работа с PageOracle](README.md#-%D0%B3%D0%BB%D0%B0%D0%B2%D0%B0-i-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0-%D1%81-pageoracle)
1. [Как пользоваться PageOracle](README.md#%D0%BA%D0%B0%D0%BA-%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D1%8C%D1%81%D1%8F-pageoracle-%D0%B2-9-%D1%88%D0%B0%D0%B3%D0%BE%D0%B2)
2. [Пользовательский интерфейс (GUI)](README.md#%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D1%8C%D1%81%D0%BA%D0%B8%D0%B9-%D0%B8%D0%BD%D1%82%D0%B5%D1%80%D1%84%D0%B5%D0%B9%D1%81-gui)
3. [Примеры работы](README.md#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B)
4. [Мини-чеклист, если ответ не устраивает](README.md#%D0%BC%D0%B8%D0%BD%D0%B8-%D1%87%D0%B5%D0%BA%D0%BB%D0%B8%D1%81%D1%82-%D0%B5%D1%81%D0%BB%D0%B8-%D0%BE%D1%82%D0%B2%D0%B5%D1%82-%D0%BD%D0%B5-%D1%83%D1%81%D1%82%D1%80%D0%B0%D0%B8%D0%B2%D0%B0%D0%B5%D1%82)
5. [Ошибки и как их решить](README.md#%D0%BE%D1%88%D0%B8%D0%B1%D0%BA%D0%B8-%D0%B8-%D0%BA%D0%B0%D0%BA-%D0%B8%D1%85-%D1%80%D0%B5%D1%88%D0%B0%D1%82%D1%8C)

[Глава II. Как работает PageOracle](README.md#%EF%B8%8F%D0%B3%D0%BB%D0%B0%D0%B2%D0%B0-ii-%D0%BA%D0%B0%D0%BA-%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%D0%B5%D1%82-pageoracle)
1. [Краткое описание работы по шагам](README.md#краткое-описание-работы-по-шагам)
2. [Подробное описание работы по шагам](README.md#подробное-описание-работы-по-шагам)
3. [Обработка и индексирование документов](README.md#%D0%BE%D0%B1%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D0%B0-%D0%B8-%D0%B8%D0%BD%D0%B4%D0%B5%D0%BA%D1%81%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%B4%D0%BE%D0%BA%D1%83%D0%BC%D0%B5%D0%BD%D1%82%D0%BE%D0%B2)
4. [PageOracle Backend (движок искусственного интеллекта)](README.md#pageoracle-backend-%D0%B4%D0%B2%D0%B8%D0%B6%D0%BE%D0%BA-%D0%B8%D1%81%D0%BA%D1%83%D1%81%D1%81%D1%82%D0%B2%D0%B5%D0%BD%D0%BD%D0%BE%D0%B3%D0%BE-%D0%B8%D0%BD%D1%82%D0%B5%D0%BB%D0%BB%D0%B5%D0%BA%D1%82%D0%B0)
5. [Интеграция и настройка LLM](README.md#%D0%B8%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D1%8F-%D0%B8-%D0%BD%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%B9%D0%BA%D0%B0-llm)
6. [Управление историей чата](README.md#%D1%83%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D0%B8%D1%81%D1%82%D0%BE%D1%80%D0%B8%D0%B5%D0%B9-%D1%87%D0%B0%D1%82%D0%B0)
7. [Гибридный поиск информации](README.md#%D0%B3%D0%B8%D0%B1%D1%80%D0%B8%D0%B4%D0%BD%D1%8B%D0%B9-%D0%BF%D0%BE%D0%B8%D1%81%D0%BA-%D0%B8%D0%BD%D1%84%D0%BE%D1%80%D0%BC%D0%B0%D1%86%D0%B8%D0%B8)
8. [Рабочий процесс ИИ-агента (LangGraph)](README.md#%D1%80%D0%B0%D0%B1%D0%BE%D1%87%D0%B8%D0%B9-%D0%BF%D1%80%D0%BE%D1%86%D0%B5%D1%81%D1%81-%D0%B8%D0%B8-%D0%B0%D0%B3%D0%B5%D0%BD%D1%82%D0%B0-langgraph)


## 🚀 Глава I. Работа с PageOracle
### Как пользоваться PageOracle в 10 шагов
...
cd pageoracle
```
3. Перейдите в папку с нужным GUI интерфейсом
```bash
cd web_gui_pageoracle
```
или
```bash
cd tkinter_gui
...
4. Предварительно поместите файлы книг с форматом `.txt.` в папку с программой
5. Запустите PageOracle с помощью Python 3.10+
```bash
python gui.py
```
...
<img width="453" height="1065" alt="Меню настроек" src="https://github.com/user-attachments/assets/75fbc1b6-02f0-4300-be9c-f9dd920cf482" />
<img width="734" height="997" alt="Снимок экрана 2026-03-25 174147" src="https://github.com/user-attachments/assets/7e556465-15c1-48de-8069-56f232f6c3ef" />
...
8. Дождитесь создание векторного хранилища (при последующих заходах в приложение ждать не потребуется) 6-10 мин (при использовании онлайн embedding-модели nvidia/llama-nemotron-embed-vl-1b-v2:free)
9. Принудительно выберите режим работы при необходимости:
...
10. Введите ваш запрос в поле ввода и дождитесь ответа от ИИ.
...
<ol start="2">
  ...
  <li> Программная реализация на Tkinter:</li>
  <ul>
  ...
  <li> Toplevel — всплывающие окна (например, для настроек).</li>
    ...
    <li> Программная реализация на Flask (Web API):</li> 
    <ul> 
    <li> Flask — веб-приложение и маршруты API;</li> 
    <li> WebAppState — централизованное состояние интерфейса в памяти (чат, логи, статус, настройки);</li> 
    <li> state_lock (RLock) — защита чтения/записи состояния от гонок;</li> 
    <li> operation_lock (Lock) — запрет параллельных долгих операций (инициализация, чат, загрузка, смена настроек);</li> 
    <li> PageOracleBackend — подключение AI-ядра (инициализация, вопрос-ответ, индексация книг);</li> 
    <li> REST endpoints — точки управления: /api/state, /api/init, /api/upload, /api/chat, /api/settings, /api/mode, очистка чата/истории/логов;</li> 
    <li> JSON settings/history — сохранение настроек и истории диалога в файлы;</li> 
    <li> NamedTemporaryFile — временное сохранение загруженного .txt перед передачей в backend;</li> 
    <li> render_template — отдача HTML-страницы интерфейса;</li> <li> jsonify — ответы фронтенду в формате JSON.</li> </ul>
    </ul>
  </ul>
</ol>

### Примеры работы
В приведённых примерах используются книги из папки Book_Example репозитория.
#### Поиск фрагментов
##### Пример 1
...
##### Пример 3 <br>
<br>
🧑 Вы: Найди фрагмент текста где говорится примерно так: "тварь ли я дрожащая или..." и допиши его<br>
<br>
🤖 PageOracle:
"Мне другое надо было узнать, другое толкало меня под руки: мне надо было узнать тогда, и поскорей узнать, вошь ли я, как все, или человек? Смогу ли я переступить или не смогу! Осмелюсь ли нагнуться и взять или нет? Тварь ли я дрожащая или право имею…"<br> 
<br>
...
### Мини-чеклист, если ответ не устраивает

1. Переключите режим на Поиск цитат.
2. Попробуйте другую модель/более мощную модель
3. Сузьте вопрос: персонаж, событие, часть/глава.
4. Повторите запрос без местоимений и расплывчатых формулировок.
5. Проверьте, что нужная книга действительно загружена.
6. При необходимости очистите историю и задайте вопрос заново. (чтобы не переполнять контекст)

### Ошибки и как их решать:

#### 1. Ошибки запуска и окружения
1. Симптом: ModuleNotFoundError при старте.<br>
   • Причина: не установлены зависимости.<br>
   • Решение: установить dependencies/requirements.txt в активной среде Python.<br>
2. Симптом: GUI не открывается или падает сразу.<br>
   • Причина: неверная Python-среда или битые зависимости tkinter/torch.<br>
   • Решение: проверить интерпретатор, переустановить зависимости, запустить снова.<br>

#### 2. Ошибки настроек провайдера/ключей
1. Симптом: [Ошибка модели] или отказ подключения модели.<br>
   • Причина: неверный API ключ или модель недоступна у выбранного провайдера.<br>
   • Решение: проверить ключ, тариф/доступ, имя модели в настройках.<br>
2. Симптом: ошибка Yandex при инициализации.<br>
   • Причина: отсутствует YC_FOLDER_ID.<br>
   • Решение: заполнить YC_FOLDER_ID в настройках и повторить инициализацию.<br>

#### 3. Ошибки embedding и индекса
1. Симптом: ошибка про mismatch dimension embedding.<br>
   • Причина: старый индекс создан другой embedding-моделью.<br>
   • Решение: разрешить приложению пересоздать индекс (автоматически), либо удалить папку chroma_intro_db вручную.<br>
2. Симптом: [Ошибка эмбеддингов] или пустые векторы.<br>
   • Причина: недоступен embedding API или неверный embedding ключ.<br>
   • Решение: проверить сеть, ключ embedding, выбранную модель.<br>
3. Симптом: OpenRouter embeddings вернул не JSON или HTTP-ошибку.<br>
   • Причина: временная проблема маршрута/лимита/модели.<br>
   • Решение: повторить позже, сменить embedding-модель, проверить OPENROUTER_API_KEY.<br>

#### 4. Ошибки поиска и качества ответа
1. Симптом: Контекст пуст: ретривер не нашёл фрагментов.<br>
   • Причина: запрос слишком общий/редкий, или книга не загружена.<br>
   • Решение: переформулировать запрос, указать персонажа/главу, проверить список загруженных книг.<br>
2. Симптом: ответы неточные или не по книге.<br>
   • Причина: слабый retrieval_query или шумный контекст.<br>
   • Решение: использовать режим Поиск цитат, сузить запрос, повысить конкретику формулировки.<br>

#### 5. Ошибки истории и файлов
1. Симптом: история не восстанавливается после перезапуска.<br>
   • Причина: повреждён chat_history.json.<br>
   • Решение: удалить/исправить chat_history.json; приложение создаст новый файл.<br>
2. Симптом: книга не добавляется.<br>
   • Причина: файл не найден, нет доступа, уже проиндексирован.<br>
   • Решение: проверить путь, права, логи; при дубликате загрузка корректно пропускается.<br>

#### 6. Сетевые и лимитные ошибки
1. Симптом: URLError/timeout/HTTP 429.<br>
   • Причина: нестабильная сеть или rate limit у провайдера.<br>
   • Решение: подождать, повторить запрос, снизить частоту операций, проверить тариф/квоты.<br>

## ⚙️Глава II. Как работает PageOracle
### Краткое описание работы по шагам
PageOracle отвечает на вопросы по загруженным книгам в формате txt.

Как это работает по шагам:
1. Книга разбивается на фрагменты (чанки).
2. Каждый фрагмент получает метаданные: название книги, часть, глава.
3. Фрагменты индексируются в Chroma (векторная база).
4. При вопросе запускается гибридный поиск:<br>
   • Семантический (vector similarity/MMR).<br>
   • Лексический (BM25 по словам).<br>
5. Результаты объединяются и переоцениваются reranker-моделью.
6. LangGraph выбирает путь:<br>
   • Ответить напрямую.<br>
   • Искать контекст.<br>
   • Переписать запрос и повторить поиск.<br>
7. LLM формирует итог в одном из режимов:<br>
...
#### 2. PageOracle Backend (движок искусственного интеллекта)
...
2. Ключевые параметры настройки:
  ...
  •  Top P (разнообразие слов),<br>
  •  Параметры поиска: Score Threshold (фильтр релевантности информации из книг).<br>
...
•  RateLimitedEmbeddings: Гарантирует, что мы не отправим слишком много запросов за короткий промежуток времени на embedding-модель от Yandex<br>
•  OpenRouterEmbeddings: Обрабатывает отправку текста в API OpenRouter для получения эмбеддингов<br>
