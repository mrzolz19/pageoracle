...
2. Сузьте вопрос: персонаж, событие, часть/глава.
3. Повторите запрос без местоимений и расплывчатых формулировок.
4. Проверьте, что нужная книга действительно загружена.
5. При необходимости очистите историю и задайте вопрос заново.
